...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngAfterViewChecked = function () {
        var user = JSON.parse(localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_3__["Constants"].URL() + '@usershop')) ?
            JSON.parse(localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_3__["Constants"].URL() + '@usershop')) : {};
        this.user = user;
    };
...
var MyPromotionHeaderComponent = /** @class */ (function () {
    ...
    MyPromotionHeaderComponent.prototype.ngOnInit = function () {
        ...
        setTimeout(function () {
            if (_this.data._id) {
                _this._startdate = new Date(_this.data.startdate);
                _this._enddate = new Date(_this.data.enddate);
                var st_time = new Date(_this.data.startdate);
                var h1 = st_time.getHours();
                var m1 = st_time.getMinutes();
                var hh1 = h1 < 9 ? '0' + h1 : h1;
                var mm1 = m1 < 9 ? '0' + m1 : m1;
                var en_time = new Date(_this.data.enddate);
                var h2 = en_time.getHours();
                var m2 = en_time.getMinutes();
                var hh2 = h2 < 9 ? '0' + h2 : h2;
                var mm2 = m2 < 9 ? '0' + m2 : m2;
                _this.data.starttime = hh1 + ':' + mm1;
                _this.data.endtime = hh2 + ':' + mm2;
                _this.isSave = true;
...
var NgChatComponent = /** @class */ (function () {
    ...
    NgChatComponent.prototype.ngOnInit = function () {
        var user = JSON.parse(localStorage.getItem(src_app_app_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].URL() + '@usershop')) ?
            JSON.parse(localStorage.getItem(src_app_app_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].URL() + '@usershop')) : {}; // me
        this.user = user;
        this.getChatList();
...
var AccountComponent = /** @class */ (function () {
    ...
    AccountComponent.prototype.getData = function () {
        var usershop = JSON.parse(window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_0__["Constants"].URL() + '@usershop'));
        this.data = usershop;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, window.localStorage.setItem(_app_constants__WEBPACK_IMPORTED_MODULE_0__["Constants"].URL() + '@usershop', JSON.stringify(this.data))];
                    case 3:
                        _a.sent();
                        this.clickShow1();
...
var InfoMyCodeComponent = /** @class */ (function () {
    ...
    InfoMyCodeComponent.prototype.ngOnInit = function () {
        ...
        var userShop = window.localStorage.getItem(src_app_app_constants__WEBPACK_IMPORTED_MODULE_9__["Constants"].URL() + '@usershop')
            ? JSON.parse(window.localStorage.getItem(src_app_app_constants__WEBPACK_IMPORTED_MODULE_9__["Constants"].URL() + '@usershop')) : {};
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.spinner.show();
                        userShop = JSON.parse(window.localStorage.getItem(src_app_app_constants__WEBPACK_IMPORTED_MODULE_9__["Constants"].URL() + '@usershop'));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userShop = JSON.parse(window.localStorage.getItem(src_app_app_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].URL() + '@usershop'));
                        this.data.shop_id = userShop.shop._id;
                        if (!this.itemId) return [3 /*break*/, 5];
                        _a.label = 1;
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        userShop = JSON.parse(window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].URL() + '@usershop'));
                        bodyReq = {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        user = JSON.parse(window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_3__["Constants"].URL() + "@usershop"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.spinner.show();
                        shop = window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_4__["Constants"].URL() + '@usershop') ? JSON.parse(window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_4__["Constants"].URL() + '@usershop')) : null;
                        objectData = {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.spinner.show();
                        shop = window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].URL() + '@usershop') ?
                            JSON.parse(window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].URL() + '@usershop')) : null;
                        objectData = {
                            shop_id: shop.shop_id,
                            status: this.status,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.dataService.warning('');
                        this.spinner.show();
                        this.shopUser = window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].URL() + '@usershop') ?
                            JSON.parse(window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].URL() + '@usershop')) : null;
                        objectData = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.dataService.warning('');
                        this.spinner.show();
                        shop = window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_3__["Constants"].URL() + '@usershop') ?
                            JSON.parse(window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_3__["Constants"].URL() + '@usershop')) : null;
                        objectData = {
                            shop_id: shop.shop_id,
                            status: this.status,
                            name: this.pageData.name,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        userShop = JSON.parse(window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_5__["Constants"].URL() + '@usershop'));
