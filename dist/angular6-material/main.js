...
var ProfileSettingComponent = /** @class */ (function () {
    ...
    ProfileSettingComponent.prototype.updateImgProfile = function (image) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].URL() + '@usershop') ? JSON.parse(window.localStorage.getItem(_app_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].URL() + '@usershop')) : null;
                        console.log(user.profileImageURL);
                        user.profileImageURL = image;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.restApi.put(_app_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].URL() + '/api/user/' + user._id, user)];
                    case 2:
                        data = _a.sent();
                        if (data['status'] === 200) {
                            this.shopUser.profileImageURL = user.profileImageURL;
                            window.localStorage.setItem(_app_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].URL() + '@usershop', JSON.stringify(data.data));
                            this.dataService.success('บันทึกข้อมูลสำเร็จ');
                            setTimeout(function () {
                                _this.dataService.success('');
                            }, 2000);
    ...
    ProfileSettingComponent.prototype.detectFiles = function (event, status) {
        ...
        var filesIndex = lodash__WEBPACK_IMPORTED_MODULE_7__["range"](files.length);
        lodash__WEBPACK_IMPORTED_MODULE_7__["each"](filesIndex, function (idx) {
            _this.currentUpload = new _upload_image_class_upload__WEBPACK_IMPORTED_MODULE_6__["ClassUpload"](files[idx]);
...
module.exports = "<input type=\"file\" (change)=\"detectFiles($event)\" multiple accept=\".png,.jpg,.gif,.svg\" />"
...
module.exports = "<div class=\"wrapper content\">\r\n  <div class=\"row\">\r\n    <div class=\"col-12\">\r\n      <h2>รูปภาพสินค้า</h2>\r\n    </div>\r\n  </div>\r\n  <div class=\"row\">\r\n    <div class=\"col-10 col-sm-10 col-md-10\">\r\n      <p class=\"header-description\">เริ่มจากการอัพโหลดรูปภาพของคุณ ทิปการถ่ายรูปให้สินค้าน่าสนใจ\r\n        กรุณาถ่ายรูปสินค้าให้ชัดเจนด้วยพื้นหลังสีขาว\r\n        และอัพหลายๆรูปเพื่อสามารถดูได้หลายๆมุม</p>\r\n    </div>\r\n    <div class=\"col-2 col-sm-2 col-md-2 txt-right\">\r\n      <p class=\"header-description\">{{images.length}}/9 รูปภาพ</p>\r\n    </div>\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-12 col-sm-4 col-md-2\" *ngFor=\"let item of images;let i = index\">\r\n      <div class=\"contrain\">\r\n        <div class=\"tools\">\r\n          <!-- <div class=\"crop\">\r\n            <mat-icon>crop</mat-icon>\r\n          </div> -->\r\n          <div class=\"remove\" (click)=\"deleteImg(i)\">\r\n            <mat-icon>delete</mat-icon>\r\n          </div>\r\n        </div>\r\n        <img [src]=\"item.url\" alt=\"image\" class=\"product-img\">\r\n        <div *ngIf=\"i === 0\" class=\"title\">\r\n          รูปภาพปก\r\n        </div>\r\n      </div>\r\n    </div>\r\n\r\n    <div class=\"col-12 col-sm-4 col-md-2\" *ngIf=\"images.length < 9\">\r\n      <div class=\"fix-col\" (click)=\"uploadImg()\">\r\n        <p>\r\n          <button mat-fab color=\"primary\">\r\n            <mat-icon>add</mat-icon>\r\n          </button>\r\n        </p>\r\n        <p class=\"add-txt\">เพิ่มรูปภาพใหม่</p>\r\n      </div>\r\n    </div>\r\n\r\n    <input type=\"file\" #productImg accept=\"image/*\" [(ngModel)]=\"productImgModel\" (change)=\"onProductImgChange($event)\"\r\n      style=\"visibility: hidden;\">\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-12 col-sm-12 col-md-12\">\r\n      ข้อมูลทั่วไป\r\n    </div>\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-0 col-sm-2 col-md-3\"></div>\r\n    <div class=\"col-12 col-sm-8 col-md-6\">\r\n      <div class=\"row\">\r\n        <div class=\"col col-12 text-center\">\r\n          <div>\r\n            <mat-form-field>\r\n              <input matInput placeholder=\"ชื่อสินค้า\" type=\"text\" [(ngModel)]=\"data.name\" required>\r\n            </mat-form-field>\r\n          </div>\r\n          <div>\r\n            <mat-form-field>\r\n              <textarea matInput rows=\"4\" placeholder=\"รายละเอียดสินค้า\" [(ngModel)]=\"data.detail\"></textarea>\r\n            </mat-form-field>\r\n          </div>\r\n          <div class=\"row\">\r\n            <div [className]=\"toggleSubMenu ? 'col-12 box-select expan' : 'col-12 box-select'\" (click)=\"expansubMenu()\">\r\n              <div class=\"ar-down\">\r\n                <mat-icon>keyboard_arrow_down</mat-icon>\r\n              </div>\r\n              <span *ngFor=\"let state of stateSubmenu;let i = index\">{{state.name}} <span *ngIf=\"stateSubmenu.length !== i + 1\">\r\n                  > </span> </span>\r\n              <span *ngIf=\"stateSubmenu.length <= 0\">เลือกหมวดหมู่</span>\r\n              <div class=\"row\" *ngIf=\"toggleSubMenu\">\r\n                <div class=\"col-4\">\r\n                  <div class=\"row box-submenu\">\r\n                    <div class=\"col-12\" *ngFor=\"let item of resData.categories\">\r\n                      <div class=\"row sub-menu\" (click)=\"expanChildren(0,item)\">\r\n                        <div class=\"col-11\">\r\n                          {{item.name}}\r\n                        </div>\r\n                        <div class=\"col-1\" *ngIf=\"item.children.length > 0\">\r\n                          >\r\n                        </div>\r\n                      </div>\r\n                    </div>\r\n                  </div>\r\n                </div>\r\n                <!-- //for loop -->\r\n                <div class=\"col-4\" *ngFor=\"let state of stateSubmenu;let i = index\">\r\n                  <div class=\"row box-submenu\">\r\n                    <div class=\"col-12\" *ngFor=\"let item of state.items\">\r\n                      <div class=\"row sub-menu\" (click)=\"expanChildren(i+1,item)\">\r\n                        <div class=\"col-11\">\r\n                          {{item.name}}\r\n                        </div>\r\n                        <div class=\"col-1\" *ngIf=\"item.children.length > 0\">\r\n                          >\r\n                        </div>\r\n                      </div>\r\n                    </div>\r\n                  </div>\r\n                </div>\r\n              </div>\r\n            </div>\r\n            <!-- <mat-form-field>\r\n              <mat-select value=\"\" [(ngModel)]=\"data.category_id\">\r\n                <mat-option value=\"\">\r\n                  เลือกหมวดหมู่\r\n                </mat-option>\r\n                <mat-option value=\"{{item._id}}\" *ngFor=\"let item of resData.categories\">\r\n                  {{item.name}}\r\n                </mat-option>\r\n              </mat-select>\r\n            </mat-form-field> -->\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"col-0 col-sm-2 col-md-3\"></div>\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-12 col-sm-12 col-md-12\">\r\n      ราคาและคลัง\r\n    </div>\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-0 col-sm-2 col-md-3\"></div>\r\n    <div class=\"col-12 col-sm-8 col-md-6\">\r\n      <div class=\"row\">\r\n        <div class=\"col col-12 text-center\">\r\n          <div *ngIf=\"!isOptions\">\r\n            <mat-form-field>\r\n              <input matInput placeholder=\"ราคา\" [(ngModel)]=\"price\" type=\"number\" required>\r\n            </mat-form-field>\r\n          </div>\r\n          <div *ngIf=\"!isOptions\">\r\n            <mat-form-field>\r\n              <input matInput placeholder=\"คลัง\" type=\"number\" [(ngModel)]=\"stock\" required>\r\n            </mat-form-field>\r\n          </div>\r\n\r\n          <div *ngIf=\"isOptions\">\r\n\r\n\r\n            <div class=\"row mgt\" *ngIf=\"isShowMainOption1\">\r\n              <div class=\"col-2 col-sm-2 col-md-2 txt-left\">\r\n                ตัวเลือกที่ 1\r\n              </div>\r\n              <div class=\"col-10 col-sm-10 col-md-10 options-ctn\">\r\n                <div class=\"del-btn\">\r\n                  <mat-icon>close</mat-icon>\r\n                </div>\r\n                <div>\r\n                  <mat-form-field>\r\n                    <input matInput placeholder=\"ใส่ชื่อตัวเลือก เช่นสี ไซส์...\" [(ngModel)]=\"nameOption1\" type=\"text\"\r\n                      required>\r\n                  </mat-form-field>\r\n                </div>\r\n                <div>\r\n                  <mat-form-field>\r\n                    <input matInput placeholder=\"ใส่ข้อมูลตัวเลือก เช่นสีแดง สีขาว...\" [(ngModel)]=\"subOption1\" type=\"text\"\r\n                      required>\r\n                  </mat-form-field>\r\n                </div>\r\n                <div *ngIf=\"subOptions_1.length > 1\">\r\n                  <div *ngFor=\"let item of subOptions_1\">\r\n                    <div class=\"sub-del-btn\">\r\n                      <mat-icon>close</mat-icon>\r\n                    </div>\r\n                    <mat-form-field>\r\n                      <input matInput placeholder=\"ใส่ข้อมูลตัวเลือก เช่นสีแดง สีขาว...\" type=\"text\" required>\r\n                    </mat-form-field>\r\n                  </div>\r\n                </div>\r\n\r\n                <div class=\"btn-option\" (click)=\"addSubOption1()\">\r\n                  <mat-icon class=\"add-cus\">add</mat-icon> เพิ่มตัวเลือก {{subOptions_1.length }}/20\r\n                </div>\r\n              </div>\r\n            </div>\r\n\r\n            <div class=\"row mgt\" *ngIf=\"isShowMainOption2\">\r\n              <div class=\"col-2 col-sm-2 col-md-2 txt-left\">\r\n                ตัวเลือกที่ 2\r\n              </div>\r\n              <div class=\"col-10 col-sm-10 col-md-10 options-ctn\">\r\n                <div class=\"del-btn\">\r\n                  <mat-icon>close</mat-icon>\r\n                </div>\r\n                <div>\r\n                  <mat-form-field>\r\n                    <input matInput placeholder=\"ใส่ชื่อตัวเลือก เช่นสี ไซส์...\" [(ngModel)]=\"nameOption2\" type=\"text\"\r\n                      required>\r\n                  </mat-form-field>\r\n                </div>\r\n                <div>\r\n                  <mat-form-field>\r\n                    <input matInput placeholder=\"ใส่ข้อมูลตัวเลือก เช่นสีแดง สีขาว...\" [(ngModel)]=\"subOption2\" type=\"text\"\r\n                      required>\r\n                  </mat-form-field>\r\n                </div>\r\n                <div>\r\n                  <div class=\"sub-del-btn\">\r\n                    <mat-icon>close</mat-icon>\r\n                  </div>\r\n                  <mat-form-field>\r\n                    <input matInput placeholder=\"ใส่ข้อมูลตัวเลือก เช่นสีแดง สีขาว...\" type=\"text\" required>\r\n                  </mat-form-field>\r\n                </div>\r\n                <div class=\"btn-option\">\r\n                  <mat-icon class=\"add-cus\">add</mat-icon> เพิ่มตัวเลือก 0/20\r\n                </div>\r\n              </div>\r\n            </div>\r\n\r\n          </div>\r\n\r\n          <div class=\"btn-option\" (click)=\"showOption(1)\" *ngIf=\"!isShowMainOption1\">\r\n            <mat-icon class=\"add-cus\">add</mat-icon> เพิ่มตัวเลือกสินค้า\r\n          </div>\r\n\r\n          <div class=\"btn-option\" (click)=\"showOption(2)\" *ngIf=\"isShowMainOption1 && !isShowMainOption2\">\r\n            <mat-icon class=\"add-cus\">add</mat-icon> เพิ่มตัวเลือกสินค้า\r\n          </div>\r\n\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"col-0 col-sm-2 col-md-3\"></div>\r\n  </div>\r\n  <!-- //ตาราง -->\r\n  <div class=\"row\" *ngIf=\"isShowMainOption1\">\r\n    <div class=\"col-2 col-sm-2 col-md-2\"></div>\r\n    <div class=\"col-10 col-sm-10 col-md-10\">\r\n      <table mat-table [dataSource]=\"dataSource\" class=\"mat-elevation-z8\">\r\n\r\n        <!--- Note that these columns can be defined in any order.\r\n              The actual rendered columns are set as a property on the row definition\" -->\r\n\r\n        <!-- Position Column -->\r\n        <ng-container matColumnDef=\"name1\" *ngIf=\"isShowCol1\">\r\n          <th mat-header-cell *matHeaderCellDef> {{nameOption1 ? nameOption1 : 'ชื่อ'}} </th>\r\n          <td mat-cell *matCellDef=\"let element\"> {{element.name1}} </td>\r\n        </ng-container>\r\n\r\n        <!-- Name Column -->\r\n        <ng-container matColumnDef=\"name2\" *ngIf=\"isShowCol2\">\r\n          <th mat-header-cell *matHeaderCellDef> {{nameOption2 ? nameOption2 : 'ชื่อ'}} </th>\r\n          <td mat-cell *matCellDef=\"let element\"> {{element.name2}} </td>\r\n        </ng-container>\r\n\r\n        <!-- Weight Column -->\r\n        <ng-container matColumnDef=\"price\">\r\n          <th mat-header-cell *matHeaderCellDef> ราคา </th>\r\n          <td mat-cell *matCellDef=\"let element\"> {{element.price}} </td>\r\n        </ng-container>\r\n\r\n        <!-- Symbol Column -->\r\n        <ng-container matColumnDef=\"stock\">\r\n          <th mat-header-cell *matHeaderCellDef> คลัง </th>\r\n          <td mat-cell *matCellDef=\"let element\"> {{element.stock}} </td>\r\n        </ng-container>\r\n\r\n        <tr mat-header-row *matHeaderRowDef=\"displayedColumns\"></tr>\r\n        <tr mat-row *matRowDef=\"let row; columns: displayedColumns;\"></tr>\r\n      </table>\r\n    </div>\r\n  </div>\r\n\r\n  <!-- wholesale -->\r\n\r\n  <div class=\"row\" *ngIf=\"isShowMainOption1\">\r\n    <div class=\"col-2 col-sm-2 col-md-2\"></div>\r\n    <div class=\"col-10 col-sm-10 col-md-10\">\r\n      <div class=\"row\">\r\n        <div class=\"col-2\">\r\n          ขายส่ง\r\n        </div>\r\n        <div class=\"col-10 contanner-wholsale\">\r\n          <div class=\"row\">\r\n            <div class=\"col-4\">\r\n\r\n            </div>\r\n            <div class=\"col-2\">\r\n              ต่ำสุด\r\n            </div>\r\n            <div class=\"col-2\">\r\n              สูงสุด\r\n            </div>\r\n            <div class=\"col-2\">\r\n              หน่วยราคา\r\n            </div>\r\n            <div class=\"col-2\">\r\n\r\n            </div>\r\n          </div>\r\n          <!-- ///// dynamic input -->\r\n          <div class=\"row\" *ngFor=\"let item of wholesaleList;let i = index\">\r\n            <div class=\"col-4 sale-txt\">\r\n              {{i + 1}}. ช่วงราคา {{i + 1}}\r\n            </div>\r\n            <div class=\"col-2\">\r\n              <mat-form-field>\r\n                <input matInput placeholder=\"ต่ำสุด\" [(ngModel)]=\"item.min\" type=\"number\">\r\n              </mat-form-field>\r\n            </div>\r\n            <div class=\"col-2\">\r\n              <mat-form-field>\r\n                <input matInput placeholder=\"สูงสุด\" [(ngModel)]=\"item.max\" type=\"number\">\r\n              </mat-form-field>\r\n            </div>\r\n            <div class=\"col-2\">\r\n              <mat-form-field>\r\n                <input matInput placeholder=\"฿ หน่วยราคา\" [(ngModel)]=\"item.price\" type=\"number\">\r\n              </mat-form-field>\r\n            </div>\r\n            <div class=\"col-2\" (click)=\"delWholesale(i)\">\r\n              <div class=\"circle-box\">\r\n                <mat-icon class=\"ic-position\">minimize</mat-icon>\r\n              </div>\r\n            </div>\r\n          </div>\r\n\r\n          <div class=\"row\">\r\n            <div class=\"col-12\">\r\n              <div class=\"box-btn\" (click)=\"addWholesale()\">\r\n                <mat-icon class=\"ic-position\">add_circle_outline</mat-icon> <span class=\"txt-icon\">เพิ่มช่วงราคา</span>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-12 col-sm-12 col-md-12\">\r\n      การจัดส่ง\r\n    </div>\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-0 col-sm-2 col-md-3\"></div>\r\n    <div class=\"col-12 col-sm-8 col-md-6\">\r\n      <div class=\"row\">\r\n        <div class=\"col col-3 sub-row\">\r\n          น้ำหนัก\r\n        </div>\r\n        <div class=\"col col-3 text-center\">\r\n          <div>\r\n            <mat-form-field>\r\n              <input matInput placeholder=\"น้ำหนัก kg\" [(ngModel)]=\"data.weight\" type=\"number\">\r\n            </mat-form-field>\r\n          </div>\r\n        </div>\r\n      </div>\r\n\r\n      <div class=\"row\">\r\n        <div class=\"col col-3 sub-row\">\r\n          ขนาดพัสดุ\r\n        </div>\r\n        <div class=\"col col-3 text-center\">\r\n          <div>\r\n            <mat-form-field>\r\n              <input matInput placeholder=\"กว้าง cm\" type=\"number\" [(ngModel)]=\"data.width\">\r\n            </mat-form-field>\r\n          </div>\r\n        </div>\r\n        <div class=\"col col-3 text-center\">\r\n          <div>\r\n            <mat-form-field>\r\n              <input matInput placeholder=\"ยาว cm\" type=\"number\" [(ngModel)]=\"data.itemlength\">\r\n            </mat-form-field>\r\n          </div>\r\n        </div>\r\n        <div class=\"col col-3 text-center\">\r\n          <div>\r\n            <mat-form-field>\r\n              <input matInput placeholder=\"สูง cm\" type=\"number\" [(ngModel)]=\"data.height\">\r\n            </mat-form-field>\r\n          </div>\r\n        </div>\r\n      </div>\r\n\r\n      <div class=\"row\">\r\n        <div class=\"col-3 sub-row\">\r\n          ค่าจัดส่ง\r\n        </div>\r\n        <div class=\"col-9\">\r\n          <div class=\"logis-label\">\r\n            เปิดการใช้งาน\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"col-12 logis-box\">\r\n              <div class=\"row\" *ngFor=\"let item of shippings;let i = index\">\r\n                <div class=\"col-6 logis-name\">\r\n                  {{item.name}}\r\n                </div>\r\n                <div class=\"col-6 logis-price\">\r\n                  <div *ngIf=\"item.isEdit\" class=\"row\">\r\n                    <div class=\"col-8\">\r\n                      <mat-form-field>\r\n                        <input matInput placeholder=\"ระบุค่าจัดส่ง\" type=\"number\" [(ngModel)]=\"item.shippingfee\">\r\n                      </mat-form-field>\r\n                    </div>\r\n\r\n                    <div class=\"col-2 ic-1\">\r\n                      <mat-icon (click)=\"submitShipping(i)\">check</mat-icon>\r\n                    </div>\r\n                    <div class=\"col-2 ic-1\">\r\n                      <mat-icon (click)=\"cancelShiping(i)\">clear</mat-icon>\r\n                    </div>\r\n\r\n                  </div>\r\n                  <div *ngIf=\"!item.isEdit\">\r\n                    ฿{{item.shippingfee ? item.shippingfee : 0 }} <span class=\"logis-ic\">\r\n                      <mat-icon class=\"add-cus\" (click)=\"toggleEditShippingPrice(i)\">create</mat-icon>\r\n                    </span>\r\n                  </div>\r\n                </div>\r\n                <!-- <div class=\"col-2\">\r\n                  <mat-slide-toggle [(ngModel)]=\"item.isChecked\"></mat-slide-toggle>\r\n                </div> -->\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class=\"col-3 sub-row\">\r\n\r\n        </div>\r\n        <div class=\"col-9\">\r\n          <div class=\"logis-label-2\">\r\n            การจัดส่งของฉัน\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"col-12 logis-box\">\r\n              <form>\r\n                <div class=\"row\" *ngFor=\"let item of resData.logistics;let i = index\">\r\n                  <div class=\"col-6 logis-name\">\r\n                    {{item.name}}\r\n                  </div>\r\n                  <div class=\"col-4 logis-price\">\r\n                    <!-- ระบุค่าจัดส่ง -->\r\n                  </div>\r\n                  <div class=\"col-2\">\r\n\r\n                    <mat-slide-toggle [checked]=\"item.isChecked\" name=\"{{item._id}}\" (change)=\"shippingChange($event,item)\"></mat-slide-toggle>\r\n\r\n                  </div>\r\n                </div>\r\n              </form>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n\r\n    </div>\r\n    <div class=\"col-0 col-sm-2 col-md-3\"></div>\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-12 col-sm-12 col-md-12\">\r\n      อื่นๆ\r\n    </div>\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-0 col-sm-2 col-md-3\"></div>\r\n    <div class=\"col-12 col-sm-8 col-md-6\">\r\n\r\n      <div class=\"row\">\r\n        <div class=\"col col-4\">\r\n          เตรียมส่งนานกว่าปกติ\r\n        </div>\r\n        <div class=\"col col-2\">\r\n          <mat-slide-toggle [(ngModel)]=\"prepare\"></mat-slide-toggle>\r\n        </div>\r\n        <div class=\"col col-6 text-remark\" *ngIf=\"!prepare\">\r\n          ฉันจะจัดส่งสินค้าภายใน 2 วัน (ไม่รวมวันหยุดนักขัตฤกษ์และวันหยุดทำการของบริษัทขนส่ง)\r\n        </div>\r\n        <div class=\"col col-6 text-remark\" *ngIf=\"prepare\">\r\n          <div>\r\n            <mat-form-field>\r\n              <input matInput placeholder=\"เวลาจัดเตรียมพัสดุ (วัน)\" type=\"number\" [(ngModel)]=\"data.prepareshipping\">\r\n            </mat-form-field>\r\n          </div>\r\n        </div>\r\n      </div>\r\n\r\n      <div class=\"row\">\r\n        <div class=\"col col-3 sub-row\">\r\n          สภาพ\r\n        </div>\r\n        <div class=\"col col-3 text-center\">\r\n          <div>\r\n            <mat-form-field>\r\n              <mat-select value=\"ของใหม่\" [(ngModel)]=\"data.condition\">\r\n                <mat-option value=\"ของใหม่\">\r\n                  ของใหม่\r\n                </mat-option>\r\n                <mat-option value=\"ของมือสอง\">\r\n                  ของมือสอง\r\n                </mat-option>\r\n              </mat-select>\r\n            </mat-form-field>\r\n          </div>\r\n        </div>\r\n      </div>\r\n\r\n    </div>\r\n    <div class=\"col-0 col-sm-2 col-md-3\"></div>\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-12 center\">\r\n      <button mat-flat-button color=\"primary\" (click)=\"save()\">บันทึก</button>\r\n    </div>\r\n  </div>\r\n\r\n\r\n</div>"
...
var InfoProductComponent = /** @class */ (function () {
    function InfoProductComponent(activatedRoute, restApi, spinner, route) {
        ...
        this.isShowCol1 = false;
        this.isShowCol2 = false;
        this.nameOption1 = '';
        this.subOption1 = '';
        this.subOption2 = '';
        this.prepare = false;
    ...
    InfoProductComponent.prototype.deleteImg = function (index) {
        var conf = window.confirm('ยืนยันการลบรูปสินค้า');
        if (conf) {
    ...
    InfoProductComponent.prototype.showOption = function (num) {
        this.isOptions = true;
        if (num === 1) {
    ...
    InfoProductComponent.prototype.onFixSubOptionNameChange = function () {
        this.dataSource = [];
    };
    InfoProductComponent.prototype.generateDataSource = function () {
    };
    InfoProductComponent.prototype.addSubOption1 = function () {
        this.subOptions_1.push({
            name: 'ตัวเลือก'
        });
    };
...
var InfoShopCategoryComponent = /** @class */ (function () {
    function InfoShopCategoryComponent(iconRegistry, sanitizer, restApi, actRoute, spinner, router) {
        this.iconRegistry = iconRegistry;
        this.sanitizer = sanitizer;
        this.restApi = restApi;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.onSaveData()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    InfoShopCategoryComponent.prototype.onChangeStatus = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.onSaveData()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
var MyProductComponent = /** @class */ (function () {
    ...
    MyProductComponent.prototype.getProduct = function (status) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MyProductComponent.prototype.onselectAll = function (event) {
        var _this = this;
        this.selectedProduct = [];
        this.productData.products.forEach(function (selectItem) {
            if (event.checked) {
    ...
    MyProductComponent.prototype.openDialog = function () {
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                _this.showDelete = false;
                _this.getProduct(_this.tabStatus);
            }
            else {
                // this.showDelete = false;
                // this.selectedProduct = [];
...
var ShopCategoryComponent = /** @class */ (function () {
    function ShopCategoryComponent(iconRegistry, sanitizer, router, restApi, spinner, dataService) {
        this.router = router;
        this.restApi = restApi;
        this.spinner = spinner;
        this.dataService = dataService;
